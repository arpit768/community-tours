  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-20">
      ...
      <div className="bg-gradient-to-r from-blue-800 to-blue-900 text-white">
        <div className="container mx-auto px-4 py-8 sm:py-12">
          <div className="max-w-4xl">
            ...
            <p className="text-blue-200 text-sm sm:text-base md:text-lg">Your next adventure awaits. Find the perfect tour.</p>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 -mt-6">
        {/* Enhanced Tabs */}
        <div className="bg-white rounded-2xl shadow-xl p-1.5 sm:p-2 mb-6 sm:mb-8 flex sm:inline-flex gap-1.5 sm:gap-2 w-full sm:w-auto">
          <button
            onClick={() => setActiveTab('browse')}
            className={`flex-1 sm:flex-none px-4 sm:px-8 py-2.5 sm:py-3 rounded-xl font-semibold transition-all text-sm sm:text-base ${
              activeTab === 'browse'
                    ...
                    <div key={booking.id} className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100 hover:shadow-xl transition-all">
                      <div className="flex flex-col md:flex-row">
                        ...
                        <div className="flex-1 p-6">
                          ...
                          <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 mb-4 p-3 sm:p-4 bg-gray-50 rounded-xl">
                            <div>
      ...
      {selectedTour && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-end sm:items-center justify-center z-50 p-0 sm:p-4 animate-fadeIn">
          <div className="bg-white rounded-t-3xl sm:rounded-3xl shadow-2xl w-full sm:max-w-lg md:max-w-2xl lg:max-w-3xl max-h-[95vh] sm:max-h-[90vh] overflow-y-auto animate-scaleIn">
            {/* Modal Header with Image */}
            <div className="relative h-40 sm:h-52 md:h-64 bg-gradient-to-br from-gray-200 to-gray-300">
              <img
            ...
            <div className="p-4 sm:p-6 md:p-8">
              <div className="mb-6 sm:mb-8">
                <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-3 sm:mb-4">Complete Your Booking</h3>

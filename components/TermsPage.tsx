      ...
      <div className="container mx-auto px-4 py-10 sm:py-14 max-w-4xl">
        <div className="bg-white rounded-2xl shadow-md border border-gray-100 p-6 sm:p-10 space-y-8 text-sm text-gray-700 leading-relaxed">
          ...
          <section>
            ...
            <p>By accessing or using the services provided by Community Tours and Travels Pvt. Ltd. ("Company", "we", "us"), you agree to be bound by these Terms and Conditions. If you do not agree with any part of these terms, you may not use our services.</p>
          </section>

          <section>
            <h2 className="text-lg font-bold text-navy-800 mb-3">2. Services</h2>
            <p>Community Tours and Travels provides tour packages, trekking expeditions, cultural tours, wildlife safaris, and related travel services within Nepal. All tours are subject to availability and may be modified due to weather, government regulations, or safety considerations.</p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>Community Tours and Travels is not liable for any loss arising from inadequate travel documentation or insurance.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>Community Tours and Travels acts as an agent for hotels, airlines, transport providers, and other third-party services. We are not liable for any injury, loss, damage, delay, or irregularity caused by the actions or defaults of these third parties, or by events beyond our reasonable control (force majeure).</p>
          </section>

          <section>
            <h2 className="text-lg font-bold text-navy-800 mb-3">7. Intellectual Property</h2>
            <p>All content on this website, including text, images, logos, and design elements, is the property of Community Tours and Travels Pvt. Ltd. and is protected by copyright laws. Unauthorized reproduction or distribution is prohibited.</p>
          </section>
